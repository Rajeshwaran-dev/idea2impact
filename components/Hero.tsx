    ...
    <>
      <section className="hero">
        ...
        <div className="hero-container">
          ...
          <p className="hero-organizers fade-in">
          ...
          <div className="features-grid">
            <div className="feature-card fade-in">
              ...
              <p className="feature-description">
                ...
                industry-standard development practices, collaborative
                workflows, and agile methodologies while building your solution.
              </p>
            </div>
            ...
            <div className="feature-card fade-in">
              ...
              <p className="feature-description">
                ...
                exclusive merchandise. Top teams receive recognition
                certificates from our organizing partners.
              </p>
            </div>
            ...
            <div className="feature-card fade-in">
              ...
              <p className="feature-description">
                Build solutions that address actual problems faced by
                communities, businesses, or society. Your project could be the
                next big innovation.
              </p>
            </div>
            ...
            <div className="feature-card fade-in">
              ...
              <p className="feature-description">
                Create impactful projects that address real challenges faced by
                businesses and society. Your idea could become the next
            ...
            <div className="feature-card fade-in">
              ...
              <p className="feature-description">
                ...
                performers may receive direct internship offers and job
            ...
            <div className="timeline-item fade-in">
              ...
              <div className="timeline-content">
                ...
                <p className="timeline-description">
                  Register individually or as a team (2-4 members). Complete
                  your profile, select your problem statement, and get ready for
                  the kickoff session.
                </p>
              </div>
            </div>
            ...
            <div className="timeline-item fade-in">
              ...
              <div className="timeline-content">
                ...
                <p className="timeline-description">
                  ...
                  your innovation, technical execution, and the real-world
      ...
      <section className="section section-dark">
        <div className="container">
          <div className="section-header">
            <div className="section-badge section-badge-light">
              By The Numbers
            </div>
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-description">
              Idea2Impact welcomes students, tech enthusiasts, and problem
              solvers from all backgrounds and skill levels.
            </p>
          </div>
          ...
          <div className="features-grid">
            ...
            <div className="feature-card fade-in">
              ...
              <p className="feature-description">
                ...
                building innovative tech solutions regardless of formal
                education.
              </p>
              <button className="feature-cta" onClick={onOpenModal}>
            ...
            <div className="feature-card fade-in">
              ...
              <p className="feature-description">
                ...
                mentorship, and support to help beginners get started and
                succeed.
              </p>
              <button className="feature-cta" onClick={onOpenModal}>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <div className="faq-item fade-in">
              ...
              <div className="faq-answer">
                <p>
                  The hackathon is open to college students, recent graduates,
                  and tech enthusiasts of all skill levels. You can participate
            ...
            <div className="faq-item fade-in">
              ...
              <div className="faq-answer">
                <p>
                  No! Participation in Idea2Impact is completely free. We
                  believe in making innovation accessible to everyone,
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <p className="footer-organizers">
            A joint initiative by Askeva Communications, GenieBox, and
            Adhiyamaan College of Engineering
          </p>
          <p className="footer-text">
            &copy; 2026 Idea2Impact. All rights reserved.
          </p>
        </div>
      </footer>
    </>
